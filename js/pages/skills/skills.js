...
const details = [
  ...
  },
  {
    ...
    icon: "",
    story:
      "Once I learned tailwind, I realized that the Bootstrap seem harder than it.",
    progress: "80%",
  },
  {
    title: "HTML",
...
function scrollUpdate() {
  if (!stopScroll) {
    ...
    if (clonesHeight + scrollPosition - 277 >= scrollHeight) {
      setScrollPosition(1);
      stopScroll = true;
    } else if (scrollPosition <= 0) {
      stopScroll = true;
      setScrollPosition(scrollHeight - clonesHeight + 277);
    }
